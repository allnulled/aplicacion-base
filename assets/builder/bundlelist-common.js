...
module.exports = [
  ...
  `${projectRoot}/assets/framework/nwt-unificated-error.js`,
  ...
  `${projectRoot}/assets/framework/nwt-events/nwt-keyed-events-manager.js`,
  ...
  `${projectRoot}/assets/framework/nwt-decorable-tree.js`,
  ...
  `${projectRoot}/assets/framework/nwt-static.js`,
  ...
  `${projectRoot}/assets/framework/nwt-cron/nwt-cron-expression.js`,
  `${projectRoot}/assets/framework/nwt-cron/nwt-cron-persistible-job.js`,
  ...
  `${projectRoot}/assets/framework/nwt-indexer.js`,
  ...
  `${projectRoot}/assets/framework/nwt-service/nwt-service.js`,
  `${projectRoot}/assets/framework/nwt-service/nwt-service-manager.js`,
