...
const allModules = [
  ...
  `${projectRoot}/assets/framework/browser/cron/croner.js`,
  `${projectRoot}/assets/framework/browser/cron/cronstrue.js`,
  `${projectRoot}/assets/framework/browser/cron/cronstrue.locale-es.js`,
  ...
  `${projectRoot}/assets/framework/browser/components/nwt-cron/nwt-cron-expression.js`,
  `${projectRoot}/assets/framework/browser/components/nwt-cron/nwt-cron-persistible-job.js`,
  `${projectRoot}/assets/framework/browser/components/nwt-cron/nwt-cron-manager.js`,
  `${projectRoot}/assets/framework/browser/components/nwt-cron/nwt-cron-job-form/nwt-cron-job-form`,
  `${projectRoot}/assets/framework/browser/components/nwt-cron/nwt-cron-manager-viewer/nwt-cron-manager-viewer`,
