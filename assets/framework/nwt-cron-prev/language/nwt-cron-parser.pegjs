...
Signification "{action}" = _* t:(Text_wrapped / Rest_of_line) { return {action:t} }

Text_wrapped = "<<" t:Multiline_text ">>" { return t }
Multiline_text = ((!">>").)* { return text() }
Rest_of_line = "=" t:Oneline_text { return t; }
Oneline_text = ((!EOL).)* { return text() }
...
Time_structure_point = Time_structure_full /
    ...
    Time_structure_weekday /
    Time_structure_watchable /
    Time_structure_disambiguable_1 /
    Time_structure_disambiguable_2 /
    Time_structure_disambiguable_3
...
Time_structure_weekday = w:Weekday_name { return CronFactory.calendarable({ weekday: w }) }
Time_structure_disambiguable_1 = d:Day_ambiguous_expression " " w:Watchable_expression { return CronFactory.calendarable({...d,...w}); }
Time_structure_disambiguable_2 = d:Day_ambiguous_expression " " h:Hour_ambiguous_expression { return CronFactory.calendarable({...d,hour:h}); }
Time_structure_disambiguable_3 = d:Day_hour_ambiguous_expression { return CronFactory.calendarable(d); }

Day_ambiguous_expression =
    day:Day_symbol
    weekday:Weekday_name_prespaced?
        { return CronFactory.calendarable(weekday ? {weekday,day} : {day}) }

Hour_ambiguous_expression = Hour_symbol

Day_hour_ambiguous_expression = it:Two_numbers_or_wildcard { return CronFactory.calendarable({ ambiguous: it }) }

Weekday_name_prespaced = " " w:Weekday_name { return w }
...
Month_name "{month}" = "enero" { return 0 } /"febrero" { return 1 } /"marzo" { return 2 } /"abril" { return 3 } /"mayo" { return 4 } /"junio" { return 5 } /"julio" { return 6 } /"agosto" { return 7 } /"septiembre" { return 8 } /"octubre" { return 9 } /"noviembre" { return 10 } /"diciembre" { return 11 } 
Weekday_name "{weekday}" = "lunes" { return 0 } /"martes" { return 1 } /"miércoles" { return 2 } /"miercoles" { return 2 } /"jueves" { return 3 } /"viernes" { return 4 } /"sábado" { return 5 } /"sabado" { return 5 } /"domingo" { return 6 } 
