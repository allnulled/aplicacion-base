...
const checkers = [
  ...
  [() => NwtResource.for("control/for/text").api.control.validation.validateValue("texto").success === true, "Should return property success=true (2)"],
  ...
  [() => NwtResource.for("control/for/structure").api.control.validation.validateValue({ name: "text" }, schemas.first).success === true, "Should return property success=true when passing object without missin (and not nullable) properties (8.2)"],
  ...
  [() => NwtResource.for("control/for/structure").api.control.validation.validateValue({ name: "500" }, schemas.first).success === true, "Should return property success=true when passing value's property name with good type (12)"],
  [() => NwtResource.for("control/for/structure").api.control.validation.validateValue({ name: "500" }, schemas.second).error === true, "Should return property success=true when passing bad schema (13)"],
  ...
  [() => NwtResource.for("control/for/structure").api.control.validation.validateValue({ name: "text", was: { started: "text", ended: "text", firstly: { started: "text", ended: "text" } } }, schemas.third).success === true, "Should return property success=true when passing nested structures without validation errors inside (15)"],
  [() => NwtResource.for("control/for/structure").api.control.validation.validateValue({ name: "text", was: { started: "text", ended: "text", firstly: { started: "text", ended: "text" } } }, schemas.third).success === true, "Should return property success=true when passing nested structures without validation errors inside (16)"],
  [() => true, "✅⬛️ Method «NwtResource.prototype.api.control.validation.validateValue» from «control/for/list» should..."],
  [() => NwtResource.for("control/for/list").api.control.validation.validateValue([], schemas.fourth).success === true, "Should return property success=true when passing empty list (17)"],
  [() => NwtResource.for("control/for/list").api.control.validation.validateValue(["text", "text", "text"], schemas.fourth).success === true, "Should return property success=true when passing well-formed list (18)"],
  ...
  [() => NwtResource.for("control/for/list").api.control.validation.validateValue([{ name: "text" }], schemas.fifth).success === true, "Should return property success=true when passing well-formed list with nested structures (20)"],
  [() => NwtResource.for("control/for/list").api.control.validation.validateValue([{ name: "text" }, { name: "text" }], schemas.fifth).success === true, "Should return property success=true when passing well-formed list with nested structures (21)"],
  ...
  [() => NwtResource.for("control/for/option").api.control.validation.validateValue({ one: "text" }, schemas.sixth).discriminators === 1, "Should return discriminators=1 when passing data that matches the first option (27)"],
  [() => NwtResource.for("control/for/option").api.control.validation.validateValue({ two: "text" }, schemas.sixth).discriminators === 2, "Should return discriminators=2 when passing data that matches the second option (28)"],
];
